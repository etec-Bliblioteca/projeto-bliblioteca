...
require_once('phpActions/selectAgendamento.php')
?>
<!DOCTYPE html>
<html lang="pt-br">
  ...
  <section class="adm">
    <article class="agdAtuais">
      ...
      <!-- <div class="cardAgd">
          ...
          <p>Periodico: Sei lá</p>
          <p>Data de Entrega: 10/10/2010</p>
          <div class="btnAgd">
            <button type="submit" class="btnEntregar">Comfirmar</button>
            <button type="submit" class="btnAdiar">
              Adiar
            </button>
            <button type="submit" class="btnChamar">
              Chamar
            </button>
          </div>
        </div> -->
    </article>
    <article class="agdVencidos">
      <h1>Agendamentos Vencidos</h1>
      <?php createVencido() ?>
    </article>
  </section>
