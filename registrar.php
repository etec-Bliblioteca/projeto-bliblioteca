...
<body>
  ...
  <section class="login">
    <div class="form-container">
      ...
      <form class="form" action="phpActions/cadAluno.php" method="post">
        <div class="form-cad-group">
        ...
        <div class="input-group">
          ...
          <div class="field-select">
            <select name="slAno" id="slAno" class="input-select" required>
              <option value="1°">1°</option>
              <option value="2°">2°</option>
              <option value="3°">3°</option>
            </select>
            <select name="slTurma" id="slTurma" class="input-select">
              <option value="Infomática">Infomática</option>
              <option value="Adiministração">Adiministração</option>
              <option value="Logistica">Logistica</option>
              <option value="Marketing">Marketing</option>
            </select>
            <select name="slPeriodo" id="slPeriodo" class="input-select">
        ...
        <br />
        <button class="sign" type="submit" name="btnCadastrar">
          Registrar
        </button>
      </form>
      <div class="social-message">
        <div class="line"></div>
        <p class="message">Já tem uma conta?</p>
        <div class="line"></div>
      </div>
      <a href="login.php" class="sign">Entrar</a>
    </div>
  </section>
  <script>
    // CODIGO PARA VER A SENHA
